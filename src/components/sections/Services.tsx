...
const features: Feature[] = [
  {
    ...
    description:
      "We design and manage various methods for you to carry out all cloud infrastructure needs with modern solutions.",
    icon: (
      <svg
  ...
  },
  {
    ...
    description:
      "We design, train, and serve AI models that seamlessly integrate with enterprise systems, or deliver full-stack AI solutions, including hardware products powered by intelligent models.",
    icon: (
      <svg
        width="800px"
        height="800px"
  ...
  
  {
    name: "Hybrid Cloud",
    description:
      "We ensure that our products and services run seamlessly across your hybrid and dynamic cloud environments - providing reliability, availability, and performance no matter where they are deployed.",
    icon: (
      <svg
        xmlns="http://www.w3.org/2000/svg"
        fill="none"
  ...
  },
  {
    ...
    description:
      "We deploy and manage containerized applications with Kubernetes and OpenShift, enabling flexibility, portability, and rapid application delivery.",
    icon: (
      <svg
        xmlns="http://www.w3.org/2000/svg"
        x="0px"
  ...
  },
  {
    ...
    description:
      "We design, install, and optimize databases tailored to your business needs.",
    icon: (
      <svg
        xmlns="http://www.w3.org/2000/svg"
        fill="none"
  ...
  },
  {
    name: "Training",
    description:
      "We provide hands-on training to equip your teams with the knowledge and skills to effectively use and manage the technologies we implement.",
    icon: (
      <svg
        xmlns="http://www.w3.org/2000/svg"
        fill="none"
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8">
          {features.map((feature) => (
            ...
            >
              <div className="group relative bg-gray-100 rounded-2xl p-6 h-64 transition hover:bg-[#13787F] cursor-pointer">
