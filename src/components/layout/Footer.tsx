...
const navigation = {
  ...
  social: [
    ...
    // },
    {
      ...
      2.24 5 5 5h14c2.76 0 5-2.24 5-5V5c0-2.76-2.24-5-5-5zm-11 
      19H5V9h3v10zM6.5 7.5C5.12 7.5 4 6.38 
      4 5s1.12-2.5 2.5-2.5S9 3.62 9 
      5s-1.12 2.5-2.5 2.5zm12.5 
      11h-3v-5c0-1.1-.9-2-2-2s-2 
      .9-2 2v5h-3V9h3v1.22C13.07 
      9.45 14 9 15 9c2.21 0 4 1.79 
      4 4v6z"
          />
        </svg>
      ),
      ...
      <div className="mx-auto max-w-7xl px-6 pt-16 pb-8 sm:pt-24 lg:px-8 lg:pt-32">
        <div className="xl:grid xl:grid-cols-3 xl:gap-8">
          <div className="space-y-8">
            <img
              alt="Company name"
              src="/favicon/opedcodelogo.svg"
              className="h-9"
            />
            <p className="text-sm/6 text-balance text-gray-300">
              Building smarter solutions that turn complexity into clarity.{" "}
            </p>
        ...
        <div className="mt-16 border-t border-white/10 pt-8 sm:mt-20 lg:mt-24">
          <p className="text-sm/6 text-gray-400">
            &copy; 2025 OpenCode Solutions, Inc. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
